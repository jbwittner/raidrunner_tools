...
COPY public."character" (account_id, average_item_level, character_id, character_level, equipped_item_level, is_active, last_login_timestamp, playable_class_id, playable_race_id, realm_id, character_name) FROM stdin;
\.
